...
def write_config(project_id, environment):
    ...
    config = {
        ...
        "proxy_routes": {
            ...
            "openbao-basic": {
                "profile": "openbao-integration",
                "base_url": "http://upstream-basic:8081",
                "injection": {
                    "type": "basic",
                    "username": "av-user",
                    "password_secret_key": "OPENBAO_MARKER",
                },
                "allowed_methods": ["GET"],
                "allowed_path_prefixes": ["/basic"],
                "allowed_request_headers": ["accept"],
                "allowed_response_headers": ["content-type", "x-reflected-secret"],
                "allowed_query_parameters": [],
                "allowed_content_types": [],
            ...
            "openbao-body": {
                "profile": "openbao-integration",
                "base_url": "http://upstream-body:8081",
                "injection": {
                    "type": "bearer",
                    "secret_key": "OPENBAO_MARKER",
                },
                "body_substitutions": {
                    "__AV_SECRET_TOKEN__": "OPENBAO_MARKER",
                },
                "allowed_methods": ["POST"],
                "allowed_path_prefixes": ["/body"],
                "allowed_request_headers": ["accept", "content-type"],
                "allowed_response_headers": ["content-type"],
                "allowed_query_parameters": [],
            ...
            "openbao-stream": {
                "profile": "openbao-integration",
                "base_url": "http://upstream-stream:8081",
                "injection": {
                    "type": "bearer",
                    "secret_key": "OPENBAO_MARKER",
                },
                "allowed_methods": ["GET"],
                "allowed_path_prefixes": ["/stream"],
                "allowed_request_headers": ["accept"],
                "allowed_response_headers": ["content-type"],
                "allowed_query_parameters": [],
                "allowed_content_types": [],
            ...
            "openbao-dynamic-buffered": {
                "profile": "openbao-dynamic",
                "base_url": "http://upstream-dynamic:8081",
                "injection": {
                    "type": "bearer",
            ...
            "openbao-dynamic-stream": {
                "profile": "openbao-dynamic",
                "base_url": "http://upstream-dynamic-stream:8081",
                "injection": {
                    "type": "bearer",
                    "secret_key": "DATABASE_PASSWORD",
                },
                "allowed_methods": ["GET"],
                "allowed_path_prefixes": ["/dynamic-stream"],
                "allowed_request_headers": ["accept"],
                "allowed_response_headers": ["content-type"],
                "allowed_query_parameters": [],
                "allowed_content_types": [],
            ...
            "openbao-dynamic-error": {
                "profile": "openbao-dynamic",
                "base_url": "http://upstream:9",
                "injection": {
                    "type": "bearer",
                    "secret_key": "DATABASE_PASSWORD",
                },
                "allowed_methods": ["GET"],
                "allowed_path_prefixes": ["/dynamic-error"],
                "allowed_request_headers": ["accept"],
